...
import { ArrowRight, CheckCircle2, Factory, Home, Building2, ShieldCheck } from "lucide-react";
import { cn } from "@/lib/utils";
import { Button } from "@/components/ui/button";
import StaticPageHeader from "@/components/landing/StaticPageHeader";

export const metadata = {
  title: "Solar Services | Suntrix Energy",
  description: "Explore our range of solar solutions including Residential, Commercial, Industrial, and Maintenance services.",
};
  ...
  return (
    <div className="relative isolate min-h-screen">
      <StaticPageHeader 
        title="Our"
        highlight="Expertise"
        description="From residential rooftops to massive industrial plants, we deliver custom solar energy systems designed for maximum ROI and long-term reliability."
      />
      ...
      <div className="container mx-auto px-6 py-16 md:py-24">
        ...
        {services.length === 0 ? (
          <div className="text-center py-20 bg-white/40 backdrop-blur-md rounded-[2.5rem] border border-slate-200">
            <p className="text-slate-500">Our services are currently being updated. Please check back soon.</p>
          </div>
        ) : (
        ...
        <div className="mt-24 rounded-[3rem] bg-slate-950 p-8 md:p-16 text-center relative overflow-hidden">
             ...
             <div className="relative z-10 max-w-2xl mx-auto">
                ...
                <p className="text-slate-400 text-lg mb-10">
                    Our experts help you analyze your energy load and site conditions to recommend the most optimized system.
                </p>
                <div className="flex flex-wrap items-center justify-center gap-4">
                    ...
                    <Link href="/contact">
                        <Button variant="outline" className="h-14 px-10 rounded-full font-bold text-base text-white border-white/10 hover:bg-white/5 transition-colors">
                            Talk to an Expert
                        </Button>
                    </Link>
                </div>
