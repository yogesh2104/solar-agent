...
const projects = [
  {
    id: 1,
    title: "SunHaven Energy Project",
    year: "2023",
    image: "/images/new_landing/project1.png",
    description: "Industrial scale agricultural solar integration for commercial harvesting.",
    location: "Karnataka, India"
  },
  {
    id: 2,
    title: "The Bantraak Fields",
    year: "2023",
    image: "/images/new_landing/hero.png",
    description: "Grid-independent solar solutions for remote agricultural complexes.",
    location: "Tamil Nadu, India"
  },
  {
    id: 3,
    title: "Seminyak Ecoray",
    year: "2022",
    image: "/images/new_landing/about.png",
    description: "Sustainable power for modernized traditional farming practices.",
    location: "Kerala, India"
  },
  {
    id: 4,
    title: "EcoHarvest Ecoray",
    year: "2022",
    image: "/images/new_landing/hero.png",
    description: "Carbon footprint reduction with high-efficiency PV arrays.",
    location: "Gujarat, India"
  }
];

export default function AgroProjects() {
  return (
      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
          <div className="max-w-2xl text-left">
            ...
            >
              Discover Our Successful <br />
              <span className="text-muted-foreground font-medium">Solar Farming Projects.</span>
            </motion.h2>
          </div>
          ...
          <div className="flex flex-col items-start md:items-end gap-6">
            <p className="text-sm text-muted-foreground/80 max-w-sm md:text-right">
              ...
              reduce our carbon footprint while cutting down on energy costs.
            </p>
