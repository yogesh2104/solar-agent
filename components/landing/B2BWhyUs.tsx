...
export default function B2BWhyUs() {
  ...
  return (
    <section
      id="why-us"
      className="relative overflow-hidden bg-[#f7faf9] py-12 md:py-24"
    >
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="max-w-3xl">
          ...
          <h2
            className="mt-5 text-3xl font-semibold tracking-tight text-[#0f172a] md:mt-6 md:text-5xl"
        ...
        <div className="mt-10 grid gap-6 xl:grid-cols-[1.04fr_0.96fr] md:mt-12 md:gap-8">
          {/* Image card */}
          <motion.div
            ...
            className="overflow-hidden rounded-[1.6rem] border border-[rgba(15,23,42,0.07)] shadow-sm md:rounded-[2.5rem]"
          >
          ...
          <motion.div
            ...
            className="rounded-[1.6rem] border border-[rgba(15,23,42,0.07)] bg-white p-5 shadow-sm md:rounded-[2.5rem] md:p-10"
          >
            <div className="text-[11px] font-semibold uppercase tracking-widest text-slate-400">
              What teams use us for
            </div>
            <h3
              className="mt-4 text-xl font-semibold tracking-tight text-[#0f172a] md:text-3xl"
              style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}
            >
