const siteConfig = {
  ...
  hero: {
    ...
    stageCards: {
      proof: {
        title: "Commercial-ready supply for rooftops, captive plants, and phased site rollouts.",
    ...
    metrics: [
      ...
      { value: "18", label: "states supported through sourcing and EPC partners" },
      { value: "48 hrs", label: "for first-pass feasibility and commercial response" },
    ],
  ...
  overview: {
    ...
    stats: [
      ...
      { value: "1.6M sq ft", label: "industrial and warehouse roof area assessed" },
  ...
  solutions: {
    ...
    title: "Solutions matched to load profile, site condition, and buying model.",
    description:
    ...
    rollout: [
      {
        step: "Site and load review",
        body: "We review roof geometry, sanctioned load, operating hours, and energy spend to shortlist the right panel and commercial model.",
      },
      {
        step: "Commercial and engineering fit",
        body: "We issue a feasibility pack with capacity sizing, yield assumptions, commercial options, and deployment constraints before you commit.",
      },
      {
        step: "Supply and commissioning",
        body: "Procurement, delivery, installation, and testing are sequenced to protect production schedules and reduce handoff friction.",
      },
      {
        step: "After-sales performance",
        body: "Monitoring, maintenance, and support keep the system delivering the savings your stakeholders signed off on.",
      },
    ],
  },
  whyUs: {
    ...
    pillars: [
      {
        title: "Bankable feasibility inputs",
        body: "Commercial models, technical assumptions, and payback logic packaged for operations, finance, and procurement review.",
      },
      {
        title: "Tier-1 sourcing discipline",
        body: "Equipment choices prioritize long-term output, warranty strength, and supply reliability over lowest upfront cost.",
      },
      {
        title: "Deployment that respects operations",
        body: "Execution plans are shaped around shutdown windows, site safety, and minimal interruption to business continuity.",
      },
      {
        title: "Post-install accountability",
        body: "Monitoring, maintenance, and escalation paths stay clear after go-live so the system keeps performing like an asset, not a one-off project.",
      },
    ],
  },
  projects: {
    badge: "Selected deployments",
    title: "Proof across manufacturing, logistics, retail, and institutional sites.",
    description:
    ...
    items: [
      ...
      },
      {
        ...
        scale: "780 kW multi-building installation",
        outcome: "Simplified procurement and phased commissioning across blocks",
  ...
  testimonials: {
    ...
    title: "What procurement heads and operations teams say after go-live.",
    items: [
      {
        quote:
  ...
  finalCta: {
    title: "Get a solar proposal your finance and operations teams can both approve.",
    description:
